...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            @if($isModelAssignOpen)
                    @include('livewire.user_assign_role')
            @endif
            ...
            <table class="table-fixed w-full">
                ...
                @foreach($users as $user)
                    <tr>
                        ...
                        <td class="border px-4 py-2">{{ ($user->account) ? $user->account->name : ''}}</td>
                        ...
                        <td class="border px-4 py-2">
                            ...
                            <button wire:click="assign({{ $user->id }})"
                                    class="flex px-4 py-2 bg-red-100 text-gray-900 cursor-pointer">Assign</button>
                        </td>
                    </tr>
                @endforeach
                </tbody>
